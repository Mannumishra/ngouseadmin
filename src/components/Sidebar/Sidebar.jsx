  ...
  return (
    ...
    <Link to="/" style={{textDecoration:"none", color:"#ffffff"}}>
      ...
      <nav className="nav flex-column">
        ...
        <NavLink className="nav-link d-flex" to="/Directdonation" onClick={handleNavLinkClick}>
        ...
        <div className="nav-item">
          ...
          {openDropdown === 'donations' && (
            <div className="dropdown-content">
              <NavLink className="nav-link" to="/DonationList" onClick={handleNavLinkClick}>
        ...
        <div className="nav-item">
          ...
          {openDropdown === 'earnings' && (
            <div className="dropdown-content">
              <NavLink className="nav-link" to="/Earning" onClick={handleNavLinkClick}>
        ...
        <div className="nav-item">
          ...
          {openDropdown === 'userProfile' && (
            <div className="dropdown-content">
              ...
              <NavLink className="nav-link" to="/UpdateProfile" onClick={handleNavLinkClick}>
